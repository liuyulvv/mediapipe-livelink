...
#if defined(ASIO_HAS_DECLTYPE) && defined(ASIO_HAS_NOEXCEPT) && defined(ASIO_HAS_WORKING_EXPRESSION_SFINAE)
...
struct set_value_member_trait<T, void(Vs...),
                              typename void_type<
                                  decltype(declval<T>().set_value(declval<Vs>()...))>::type> {
...
struct set_value_member_trait<T, void(),
                              typename void_type<
                                  decltype(declval<T>().set_value())>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
...
#define ASIO_PRIVATE_SET_VALUE_MEMBER_TRAIT_DEF(n)                                                         \
    ...
    struct set_value_member_trait<T, void(ASIO_VARIADIC_TARGS(n)),                                         \
                                  typename void_type<                                                      \
                                      decltype(declval<T>().set_value(ASIO_VARIADIC_DECLVAL(n)))>::type> { \
        ASIO_STATIC_CONSTEXPR(bool, is_valid = true);                                                      \
                                                                                                           \
        using result_type = decltype(declval<T>().set_value(ASIO_VARIADIC_DECLVAL(n)));                    \
                                                                                                           \
        ASIO_STATIC_CONSTEXPR(bool, is_noexcept = noexcept(                                                \
...
template <typename T, typename... Vs>
struct set_value_member_trait<T, void(Vs...)> : conditional<
                                                    is_same<T, typename remove_reference<T>::type>::value && conjunction<is_same<Vs, typename decay<Vs>::type>...>::value,
                                                    typename conditional<
                                                        is_same<T, typename add_const<T>::type>::value,
                                                        no_set_value_member,
                                                        traits::set_value_member<typename add_const<T>::type, void(Vs...)> >::type,
...
template <typename T>
struct set_value_member_trait<T, void()> : conditional<
                                               is_same<T, typename remove_reference<T>::type>::value,
                                               typename conditional<
                                                   is_same<T, typename add_const<T>::type>::value,
                                                   no_set_value_member,
                                                   traits::set_value_member<typename add_const<T>::type, void()> >::type,
                                               traits::set_value_member<typename remove_reference<T>::type, void()> >::type {
};
...
#define ASIO_PRIVATE_SET_VALUE_MEMBER_TRAIT_DEF(n)                                                                             \
    template <typename T, ASIO_VARIADIC_TPARAMS(n)>                                                                            \
    struct set_value_member_trait<T, void(ASIO_VARIADIC_TARGS(n))> : conditional<                                              \
                                                                         is_same<T, typename remove_reference<T>::type>::value \

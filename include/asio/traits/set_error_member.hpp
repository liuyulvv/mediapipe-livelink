...
struct set_error_member_trait<T, E,
                              typename void_type<
                                  decltype(declval<T>().set_error(declval<E>()))>::type> {
...
template <typename T, typename E, typename = void>
struct set_error_member_trait : conditional<
                                    is_same<T, typename remove_reference<T>::type>::value && is_same<E, typename decay<E>::type>::value,

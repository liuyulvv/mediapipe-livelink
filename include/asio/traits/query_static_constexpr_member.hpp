...
#if defined(ASIO_HAS_DECLTYPE) && defined(ASIO_HAS_NOEXCEPT) && defined(ASIO_HAS_CONSTEXPR) && defined(ASIO_HAS_CONSTANT_EXPRESSION_SFINAE) && defined(ASIO_HAS_WORKING_EXPRESSION_SFINAE)
...
template <typename T, typename Property, typename = void>
struct query_static_constexpr_member_trait : conditional<
...
struct query_static_constexpr_member_trait<T, Property,
                                           typename enable_if<
                                               (static_cast<void>(T::query(Property{})), true)>::type> {

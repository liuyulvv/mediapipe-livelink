...
#if defined(ASIO_HAS_DECLTYPE) && defined(ASIO_HAS_NOEXCEPT) && defined(ASIO_HAS_CONSTEXPR) && defined(ASIO_HAS_VARIABLE_TEMPLATES) && defined(ASIO_HAS_WORKING_EXPRESSION_SFINAE)
...
template <typename T, typename Property, typename = void>
struct static_query_trait : conditional<
                                is_same<T, typename decay<T>::type>::value && is_same<Property, typename decay<Property>::type>::value,
                                no_static_query,
                                traits::static_query<
...
struct static_query_trait<T, Property,
                          typename void_type<
                              decltype(decay<Property>::type::template static_query_v<T>)>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);

    using result_type = decltype(decay<Property>::type::template static_query_v<T>);

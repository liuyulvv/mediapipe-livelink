...
struct call_traits<S,
                   typename enable_if<
                       schedule_member<S>::is_valid>::type> : schedule_member<S> {
...
struct call_traits<S,
                   typename enable_if<
                       !schedule_member<S>::is_valid>::type,
                   typename enable_if<
                       schedule_free<S>::is_valid>::type> : schedule_free<S> {
...
template <typename S>
struct can_schedule : integral_constant<bool,
...
template <typename S>
struct is_nothrow_schedule : integral_constant<bool,

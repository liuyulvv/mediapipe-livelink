...
struct outstanding_work_t {
    ...
    static ASIO_CONSTEXPR
        ...
        static_query(
            ...
            typename enable_if<
                traits::static_query<T, untracked_t>::is_valid>::type* = 0) ASIO_NOEXCEPT {
    ...
    static ASIO_CONSTEXPR
        ...
        static_query(
            ...
            typename enable_if<
                !query_member<T>::is_valid>::type* = 0,
            typename enable_if<
                !traits::static_query<T, untracked_t>::is_valid>::type* = 0,
            typename enable_if<
                traits::static_query<T, tracked_t>::is_valid>::type* = 0) ASIO_NOEXCEPT {
        return traits::static_query<T, tracked_t>::value();
    }

    template <typename E,
              typename T = decltype(outstanding_work_t::static_query<E>())>
    static ASIO_CONSTEXPR const T static_query_v = outstanding_work_t::static_query<E>();
    ...
    friend ASIO_CONSTEXPR outstanding_work_t query(
        ...
        typename enable_if<
            can_query<const Executor&, untracked_t>::value>::type* = 0)
    ...
    friend ASIO_CONSTEXPR outstanding_work_t query(
        ...
        typename enable_if<
            !can_query<const Executor&, untracked_t>::value>::type* = 0,
        typename enable_if<
            can_query<const Executor&, tracked_t>::value>::type* = 0)
#if !defined(__clang__)  // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)   // Visual C++ wants the type to be qualified.
        ASIO_NOEXCEPT_IF((
            is_nothrow_query<const Executor&,
...
struct untracked_t {
    ...
    static ASIO_CONSTEXPR untracked_t static_query(
        ...
        typename enable_if<
            !query_member<T>::is_valid>::type* = 0,
        typename enable_if<
            !traits::query_free<T, untracked_t>::is_valid>::type* = 0,
        typename enable_if<
...
struct query_free_default<T, execution::outstanding_work_t,
                          typename enable_if<
                              can_query<T, execution::outstanding_work_t::untracked_t>::value>::type> {
...
struct query_free_default<T, execution::outstanding_work_t,
                          typename enable_if<
                              !can_query<T, execution::outstanding_work_t::untracked_t>::value && can_query<T, execution::outstanding_work_t::tracked_t>::value>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept =
...
struct static_query<T, execution::outstanding_work_t,
                    typename enable_if<
                        ...
                        traits::static_query<T,
                                             execution::outstanding_work_t::untracked_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<T, execution::outstanding_work_t,
                    typename enable_if<
                        ...
                        traits::static_query<T,
                                             execution::outstanding_work_t::tracked_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_require<T, execution::outstanding_work_t::untracked_t,
                      typename enable_if<
                          static_query<T, execution::outstanding_work_t::untracked_t>::is_valid>::type> {
...
struct static_require<T, execution::outstanding_work_t::tracked_t,
                      typename enable_if<
                          static_query<T, execution::outstanding_work_t::tracked_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid =
                                    (is_same<typename static_query<T,

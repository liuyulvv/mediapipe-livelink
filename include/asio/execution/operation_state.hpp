...
#if defined(ASIO_HAS_DEDUCED_START_FREE_TRAIT) && defined(ASIO_HAS_DEDUCED_START_MEMBER_TRAIT)
...
template <typename T>
struct is_operation_state_base : integral_constant<bool,
...
struct is_operation_state :
    ...
    conditional<
        can_start<typename add_lvalue_reference<T>::type>::value && is_nothrow_start<typename add_lvalue_reference<T>::type>::value,

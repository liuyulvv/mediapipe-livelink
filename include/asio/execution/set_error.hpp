...
struct call_traits<R, void(E),
                   typename enable_if<
                       set_error_member<R, E>::is_valid>::type> : set_error_member<R, E> {
...
struct call_traits<R, void(E),
                   typename enable_if<
                       !set_error_member<R, E>::is_valid>::type,
                   typename enable_if<
                       set_error_free<R, E>::is_valid>::type> : set_error_free<R, E> {
...
template <typename R, typename E>
struct can_set_error : integral_constant<bool,
...
template <typename R, typename E>
struct is_nothrow_set_error : integral_constant<bool,

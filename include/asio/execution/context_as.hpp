...
struct context_as_t {
    ...
    ASIO_STATIC_CONSTEXPR(bool,
                          is_applicable_property_v = (is_executor<U>::value || conditional<is_executor<U>::value, false_type, is_sender<U> >::type::value || conditional<is_executor<U>::value, false_type, is_scheduler<U> >::type::value));
    ...
    static ASIO_CONSTEXPR const U static_query_v = context_as_t::static_query<E>();
...
#if (defined(ASIO_HAS_VARIABLE_TEMPLATES) && defined(ASIO_HAS_CONSTEXPR)) || defined(GENERATING_DOCUMENTATION)
template <typename T>
...
struct static_query<T, execution::context_as_t<U>,
                    typename enable_if<
                        static_query<T, execution::context_t>::is_valid>::type> : static_query<T, execution::context_t> {
};
...
struct query_free<T, execution::context_as_t<U>,
                  typename enable_if<
                      can_query<const T&, const execution::context_t&>::value>::type> {

...
#if defined(ASIO_HAS_ALIAS_TEMPLATES) && defined(ASIO_HAS_VARIADIC_TEMPLATES) && defined(ASIO_HAS_DECLTYPE) && !defined(ASIO_MSVC) || (_MSC_VER >= 1910)
...
struct sender_traits_base<S,
                          typename enable_if<
                              !has_sender_types<S>::value && detail::is_executor_of_impl<S,
                                                                                         as_invocable<void_receiver, S>>::value>::type> {
...
struct is_sender_to :
    ...
    integral_constant<bool,
                      is_sender<T>::value && is_receiver<R>::value && can_connect<T, R>::value>
#endif  // defined(GENERATING_DOCUMENTATION)
{
};

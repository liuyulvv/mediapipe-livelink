...
struct mapping_t {
    ...
    static ASIO_CONSTEXPR
        ...
        static_query(
            ...
            typename enable_if<
                traits::static_query<T, thread_t>::is_valid>::type* = 0) ASIO_NOEXCEPT {
    ...
    static ASIO_CONSTEXPR
        ...
        static_query(
            ...
            typename enable_if<
                traits::static_query<T, new_thread_t>::is_valid>::type* = 0) ASIO_NOEXCEPT {
    ...
    static ASIO_CONSTEXPR
        ...
        static_query(
            ...
            typename enable_if<
                traits::static_query<T, other_t>::is_valid>::type* = 0) ASIO_NOEXCEPT {
    ...
    friend ASIO_CONSTEXPR mapping_t query(
        ...
        typename enable_if<
            can_query<const Executor&, thread_t>::value>::type* = 0)
    ...
    friend ASIO_CONSTEXPR mapping_t query(
        ...
        typename enable_if<
            !can_query<const Executor&, thread_t>::value>::type* = 0,
        typename enable_if<
            can_query<const Executor&, new_thread_t>::value>::type* = 0)
#if !defined(__clang__)  // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)   // Visual C++ wants the type to be qualified.
        ASIO_NOEXCEPT_IF((
    ...
    friend ASIO_CONSTEXPR mapping_t query(
        ...
        typename enable_if<
            !can_query<const Executor&, new_thread_t>::value>::type* = 0,
        typename enable_if<
            can_query<const Executor&, other_t>::value>::type* = 0)
#if !defined(__clang__)  // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)   // Visual C++ wants the type to be qualified.
        ASIO_NOEXCEPT_IF((
...
struct thread_t {
    ...
    static ASIO_CONSTEXPR thread_t static_query(
        ...
        typename enable_if<
            !query_member<T>::is_valid>::type* = 0,
        typename enable_if<
            !traits::query_free<T, thread_t>::is_valid>::type* = 0,
        typename enable_if<
            !can_query<T, new_thread_t<I> >::value>::type* = 0,
        typename enable_if<
...
struct new_thread_t {
    ...
    static ASIO_CONSTEXPR const T static_query_v = new_thread_t::static_query<E>();
#endif  // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
        //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)
...
struct query_free_default<T, execution::mapping_t,
                          typename enable_if<
                              !can_query<T, execution::mapping_t::thread_t>::value && can_query<T, execution::mapping_t::new_thread_t>::value>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept =
...
struct query_free_default<T, execution::mapping_t,
                          typename enable_if<
                              !can_query<T, execution::mapping_t::thread_t>::value && !can_query<T, execution::mapping_t::new_thread_t>::value && can_query<T, execution::mapping_t::other_t>::value>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept =
...
struct static_query<T, execution::mapping_t,
                    typename enable_if<
                        ...
                        traits::static_query<T, execution::mapping_t::thread_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<T, execution::mapping_t,
                    typename enable_if<
                        ...
                        !execution::detail::mapping_t<0>::
                            query_member<T>::is_valid &&
                        !traits::static_query<T, execution::mapping_t::thread_t>::is_valid && traits::static_query<T, execution::mapping_t::new_thread_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<T, execution::mapping_t,
                    typename enable_if<
                        ...
                        !execution::detail::mapping_t<0>::
                            query_member<T>::is_valid &&
                        !traits::static_query<T, execution::mapping_t::thread_t>::is_valid && !traits::static_query<T, execution::mapping_t::new_thread_t>::is_valid && traits::static_query<T, execution::mapping_t::other_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<T, execution::mapping_t::thread_t,
                    typename enable_if<
                        ...
                        !execution::detail::mapping::thread_t<0>::
                            query_member<T>::is_valid &&
                        !traits::query_free<T, execution::mapping_t::thread_t>::is_valid && !can_query<T, execution::mapping_t::new_thread_t>::value && !can_query<T, execution::mapping_t::other_t>::value>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_require<T, execution::mapping_t::thread_t,
                      typename enable_if<
                          static_query<T, execution::mapping_t::thread_t>::is_valid>::type> {
...
struct static_require<T, execution::mapping_t::other_t,
                      typename enable_if<
                          static_query<T, execution::mapping_t::other_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid =
                                    (is_same<typename static_query<T,

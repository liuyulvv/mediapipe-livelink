...
struct call_traits<S, void(R),
                   typename enable_if<
                       submit_member<S, R>::is_valid>::type,
                   typename enable_if<
                       is_sender_to<S, R>::value>::type> : submit_member<S, R> {
...
struct call_traits<S, void(R),
                   typename enable_if<
                       !submit_member<S, R>::is_valid>::type,
                   typename enable_if<
                       submit_free<S, R>::is_valid>::type,
                   typename enable_if<
                       is_sender_to<S, R>::value>::type> : submit_free<S, R> {
...
template <typename S, typename R>
struct can_submit : integral_constant<bool,
...
template <typename S, typename R>
struct is_nothrow_submit : integral_constant<bool,

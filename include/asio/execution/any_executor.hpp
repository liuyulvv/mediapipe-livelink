...
template <typename T>
struct is_requirable<T, typename enable_if<T::is_requirable>::type> : true_type {};

template <typename T, typename = void>
struct is_preferable : false_type {};

template <typename T>
struct is_preferable<T, typename enable_if<T::is_preferable>::type> : true_type {};
...
struct supportable_properties<I, void(Prop)> {
    ...
    template <typename T>
    struct find_convertible_property : conditional<
                                           is_same<T, Prop>::value || is_convertible<T, Prop>::value,
                                           found,
                                           not_found>::type {};

    template <typename T>
    struct find_convertible_requirable_property : conditional<
                                                      is_requirable<Prop>::value && (is_same<T, Prop>::value || is_convertible<T, Prop>::value),
                                                      found,
                                                      not_found>::type {};

    template <typename T>
    struct find_convertible_preferable_property : conditional<
                                                      is_preferable<Prop>::value && (is_same<T, Prop>::value || is_convertible<T, Prop>::value),
                                                      found,
                                                      not_found>::type {};

    struct find_context_as_property : conditional<
...
struct supportable_properties<I, void(Head, Tail...)> {
    ...
    struct find_convertible_property : conditional<
                                           ...
                                           typename supportable_properties<I + 1,
                                                                           void(Tail...)>::template find_convertible_property<T> >::type {};
    ...
    struct find_convertible_requirable_property : conditional<
                                                      ...
                                                      typename supportable_properties<I, void(Head)>::found,
                                                      typename supportable_properties<I + 1,
                                                                                      void(Tail...)>::template find_convertible_requirable_property<T> >::type {};
    ...
    struct find_convertible_preferable_property : conditional<
                                                      ...
                                                      typename supportable_properties<I, void(Head)>::found,
                                                      typename supportable_properties<I + 1,
                                                                                      void(Tail...)>::template find_convertible_preferable_property<T> >::type {};
        ...
        struct is_valid_target : integral_constant<bool,                                                                                                                              \
                                                   (                                                                                                                                  \
                                                       supportable_properties<I,                                                                                                      \
                                                                              void(Head)>::template is_valid_target<T>::value &&                                                      \
                                                       supportable_properties<I + 1,                                                                                                  \
                                                                              void(ASIO_VARIADIC_TARGS(n))>::template is_valid_target<T>::value)> {                                   \
        };                                                                                                                                                                            \
                                                                                                                                                                                      \
        template <typename T>                                                                                                                                                         \
        struct find_convertible_property : conditional<                                                                                                                               \
                                               ...
                                               typename supportable_properties<I, void(Head)>::found,                                                                                 \
                                               typename supportable_properties<I + 1,                                                                                                 \
                                                                               void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_property<T> >::type {};                       \
                                                                                                                                                                                      \
        template <typename T>                                                                                                                                                         \
        struct find_convertible_requirable_property : conditional<                                                                                                                    \
                                                          is_requirable<Head>::value && is_convertible<T, Head>::value,                                                               \
                                                          typename supportable_properties<I, void(Head)>::found,                                                                      \
                                                          typename supportable_properties<I + 1,                                                                                      \
                                                                                          void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_requirable_property<T> >::type {}; \
                                                                                                                                                                                      \
        template <typename T>                                                                                                                                                         \
        struct find_convertible_preferable_property : conditional<                                                                                                                    \
                                                          is_preferable<Head>::value && is_convertible<T, Head>::value,                                                               \
                                                          typename supportable_properties<I, void(Head)>::found,                                                                      \
                                                          typename supportable_properties<I + 1,                                                                                      \
                                                                                          void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_preferable_property<T> >::type {}; \
                                                                                                                                                                                      \
        struct find_context_as_property : conditional<                                                                                                                                \
                                              is_context_as<Head>::value,                                                                                                             \
                                              typename supportable_properties<I, void(Head)>::found,                                                                                  \
                                              typename supportable_properties<I + 1, void(                                                                                            \
                                                                                         ASIO_VARIADIC_TARGS(n))>::find_context_as_property>::type {};                                \
    };                                                                                                                                                                                \
    /**/
...
struct is_valid_target_executor : conditional<
                                      is_executor<T>::value,
    ...
    any_executor_base(Executor ex, false_type)
        : target_fns_(target_fns_table<Executor>(
              any_executor_base::query_blocking(ex,
                                                can_query<const Executor&, const execution::blocking_t&>()) == execution::blocking.always)) {
        any_executor_base::construct_object(ex,
                                            integral_constant < bool,
                                            sizeof(Executor) <= sizeof(object_type) && alignment_of<Executor>::value <= alignment_of<object_type>::value > ());
    }
...
protected:
    ...
    static const object_fns* object_fns_table(
        typename enable_if<
            !is_same<Obj, void>::value && !is_same<Obj, asio::detail::shared_ptr<void> >::value>::type* = 0) {
        static const object_fns fns =
            {
...
#pragma warning(disable : 4702)
    ...
    static void query_fn_non_void(void*, const void* ex, const void* prop,
                                  typename enable_if<
                                      asio::can_query<const Ex&, const Prop&>::value && is_same<typename Prop::polymorphic_query_result_type, void>::value>::type*) {
    ...
    static void query_fn_non_void(void* result, const void* ex, const void* prop,
                                  typename enable_if<
                                      asio::can_query<const Ex&, const Prop&>::value && !is_same<typename Prop::polymorphic_query_result_type, void>::value && is_reference<typename Prop::polymorphic_query_result_type>::value>::type*) {
        *static_cast<typename remove_reference<
            typename Prop::polymorphic_query_result_type>::type**>(result) = &static_cast<typename Prop::polymorphic_query_result_type>(asio::query(*static_cast<const Ex*>(ex),
                                                                                                                                                    *static_cast<const Prop*>(prop)));
    }
    ...
    static void query_fn_non_void(void* result, const void* ex, const void* prop,
                                  typename enable_if<
                                      asio::can_query<const Ex&, const Prop&>::value && !is_same<typename Prop::polymorphic_query_result_type, void>::value && is_scalar<typename Prop::polymorphic_query_result_type>::value>::type*) {
        *static_cast<typename Prop::polymorphic_query_result_type*>(result) = static_cast<typename Prop::polymorphic_query_result_type>(
            asio::query(*static_cast<const Ex*>(ex),
                        *static_cast<const Prop*>(prop)));
    }
    ...
    static void query_fn_non_void(void* result, const void* ex, const void* prop,
                                  typename enable_if<
                                      asio::can_query<const Ex&, const Prop&>::value && !is_same<typename Prop::polymorphic_query_result_type, void>::value && !is_reference<typename Prop::polymorphic_query_result_type>::value && !is_scalar<typename Prop::polymorphic_query_result_type>::value>::type*) {
    ...
    static Poly require_fn_impl(const void* ex, const void* prop,
                                typename enable_if<
                                    !is_same<Ex, void>::value && Prop::is_requirable>::type*) {
    ...
    static Poly prefer_fn_impl(const void* ex, const void* prop,
                               typename enable_if<
                                   !is_same<Ex, void>::value && Prop::is_preferable>::type*) {
...
public:
    ...
    friend typename enable_if<
        is_base_of<any_executor, AnyExecutor1>::value || is_base_of<any_executor, AnyExecutor2>::value,
        bool>::type
...
public:
                 ...
                 typename enable_if<
                     conditional<
                         !is_same<
                             ...
                             any_executor>::value,
                         typename detail::supportable_properties<
                             0, void(SupportableProperties...)>::template is_valid_target<any_executor<OtherSupportableProperties...> >,
                         false_type>::type::value>::type* = 0)
    ...
    template <typename T>
    struct find_convertible_property : detail::supportable_properties<
                                           0, void(SupportableProperties...)>::template find_convertible_property<T> {};
    ...
    query(const Property& p,
          typename enable_if<
              !is_same<
                  ...
                  void>::value &&
              is_reference<
                  typename find_convertible_property<Property>::query_result_type>::value>::type* = 0) const {
        typedef find_convertible_property<Property> found;
    ...
    query(const Property& p,
          typename enable_if<
              !is_same<
                  ...
                  void>::value &&
              !is_reference<
                  typename find_convertible_property<Property>::query_result_type>::value &&
              !is_scalar<
                  typename find_convertible_property<Property>::query_result_type>::value>::type* = 0) const {
        typedef find_convertible_property<Property> found;
        typename found::query_result_type* result;
    ...
    template <typename T>
    struct find_convertible_requirable_property : detail::supportable_properties<
                                                      0, void(SupportableProperties...)>::template find_convertible_requirable_property<T> {};

    template <typename Property>
    any_executor require(const Property& p,
                         typename enable_if<
                             find_convertible_requirable_property<Property>::value>::type* = 0) const {
    ...
    template <typename T>
    struct find_convertible_preferable_property : detail::supportable_properties<
                                                      0, void(SupportableProperties...)>::template find_convertible_preferable_property<T> {};

    template <typename Property>
    any_executor prefer(const Property& p,
                        typename enable_if<
                            find_convertible_preferable_property<Property>::value>::type* = 0) const {
...
#define ASIO_PRIVATE_ANY_EXECUTOR_DEF(n)                                                                                                         \
    ...
    class any_executor<ASIO_VARIADIC_TARGS(n)> : public detail::any_executor_base,                                                               \
                                                 public detail::any_executor_context<                                                            \
    ...
    public:                                                                                                                                      \
        ...
        any_executor(OtherAnyExecutor other,                                                                                                     \
                     typename enable_if<                                                                                                         \
                         conditional<                                                                                                            \
                             !is_same<OtherAnyExecutor, any_executor>::value && is_base_of<detail::any_executor_base,                            \
                                                                                           OtherAnyExecutor>::value,                             \
                             typename detail::supportable_properties<                                                                            \
                                 0, void(ASIO_VARIADIC_TARGS(n))>::template is_valid_target<OtherAnyExecutor>,                                   \
                             false_type>::type::value>::type* = 0)                                                                               \
            : detail::any_executor_base(ASIO_MOVE_CAST(                                                                                          \
        ...
        template <typename T>                                                                                                                    \
        struct find_convertible_property : detail::supportable_properties<                                                                       \
                                               0, void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_property<T> {};                       \
                                                                                                                                                 \
        template <typename Property>                                                                                                             \
        void query(const Property& p,                                                                                                            \
                   typename enable_if<                                                                                                           \
        ...
        template <typename T>                                                                                                                    \
        struct find_convertible_requirable_property : detail::supportable_properties<                                                            \
                                                          0, void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_requirable_property<T> {}; \
                                                                                                                                                 \
        template <typename Property>                                                                                                             \
        any_executor require(const Property& p,                                                                                                  \
                             typename enable_if<                                                                                                 \
        ...
        template <typename T>                                                                                                                    \
        struct find_convertible_preferable_property : detail::supportable_properties<                                                            \
                                                          0, void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_preferable_property<T> {}; \
                                                                                                                                                 \
        template <typename Property>                                                                                                             \
        any_executor prefer(const Property& p,                                                                                                   \
                            typename enable_if<                                                                                                  \
...
struct query_member<
    ...
    typename enable_if<
        execution::detail::supportable_properties<
            0, void(SupportableProperties...)>::template find_convertible_property<Prop>::value>::type> {
    static const bool is_valid = true;
    static const bool is_noexcept = false;
...
#define ASIO_PRIVATE_ANY_EXECUTOR_QUERY_MEMBER_DEF(n)                                                                  \
    ...
    struct query_member<                                                                                               \
        ...
        typename enable_if<                                                                                            \
            execution::detail::supportable_properties<                                                                 \
                0, void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_property<Prop>::value>::type> {            \
        static const bool is_valid = true;                                                                             \
        static const bool is_noexcept = false;                                                                         \
        typedef typename execution::detail::supportable_properties<                                                    \
            0, void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_property<Prop>::query_result_type result_type; \
    };                                                                                                                 \
    /**/
...
struct require_member<
    ...
    typename enable_if<
        execution::detail::supportable_properties<
            0, void(SupportableProperties...)>::template find_convertible_requirable_property<Prop>::value>::type> {
    static const bool is_valid = true;
    static const bool is_noexcept = false;
...
#define ASIO_PRIVATE_ANY_EXECUTOR_REQUIRE_MEMBER_DEF(n)                                                                \
    ...
    struct require_member<                                                                                             \
        ...
        typename enable_if<                                                                                            \
            execution::detail::supportable_properties<                                                                 \
                0, void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_requirable_property<Prop>::value>::type> { \
        static const bool is_valid = true;                                                                             \
        static const bool is_noexcept = false;                                                                         \
...
struct prefer_member<
    ...
    typename enable_if<
        execution::detail::supportable_properties<
            0, void(SupportableProperties...)>::template find_convertible_preferable_property<Prop>::value>::type> {
    static const bool is_valid = true;
    static const bool is_noexcept = false;
    typedef execution::any_executor<SupportableProperties...> result_type;
};
...
#define ASIO_PRIVATE_ANY_EXECUTOR_PREFER_FREE_DEF(n)                                                                   \
    ...
    struct prefer_member<                                                                                              \
        ...
        typename enable_if<                                                                                            \
            execution::detail::supportable_properties<                                                                 \
                0, void(ASIO_VARIADIC_TARGS(n))>::template find_convertible_preferable_property<Prop>::value>::type> { \
        static const bool is_valid = true;                                                                             \
        static const bool is_noexcept = false;                                                                         \
        typedef execution::any_executor<ASIO_VARIADIC_TARGS(n)> result_type;                                           \
    };                                                                                                                 \

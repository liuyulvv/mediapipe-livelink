...
#if defined(ASIO_HAS_DEDUCED_SET_DONE_FREE_TRAIT) && defined(ASIO_HAS_DEDUCED_SET_DONE_MEMBER_TRAIT) && defined(ASIO_HAS_DEDUCED_SET_ERROR_FREE_TRAIT) && defined(ASIO_HAS_DEDUCED_SET_ERROR_MEMBER_TRAIT) && defined(ASIO_HAS_DEDUCED_SET_VALUE_FREE_TRAIT) && defined(ASIO_HAS_DEDUCED_SET_VALUE_MEMBER_TRAIT) && defined(ASIO_HAS_DEDUCED_RECEIVER_OF_FREE_TRAIT) && defined(ASIO_HAS_DEDUCED_RECEIVER_OF_MEMBER_TRAIT)
...
struct is_receiver_base : integral_constant<bool,
                                            is_move_constructible<typename remove_cvref<T>::type>::value && is_constructible<typename remove_cvref<T>::type, T>::value> {
};
...
struct is_receiver :
    ...
    conditional<
        can_set_done<typename remove_cvref<T>::type>::value && is_nothrow_set_done<typename remove_cvref<T>::type>::value && can_set_error<typename remove_cvref<T>::type, E>::value && is_nothrow_set_error<typename remove_cvref<T>::type, E>::value,
...
template <typename T>
struct is_receiver_of<T> : conditional<
                               is_receiver<T>::value,
...
#define ASIO_PRIVATE_RECEIVER_OF_TRAITS_DEF(n)                                                                   \
    ...
    struct is_receiver_of<T, ASIO_VARIADIC_TARGS(n)> : conditional<                                              \
...
struct is_nothrow_receiver_of :
    ...
    integral_constant<bool,
                      is_receiver_of<T, Vs...>::value && is_nothrow_set_value<typename remove_cvref<T>::type, Vs...>::value>
#endif  // defined(GENERATING_DOCUMENTATION)
{
};
...
template <typename T>
struct is_nothrow_receiver_of<T> : integral_constant<bool,
                                                     is_receiver_of<T>::value && is_nothrow_set_value<typename remove_cvref<T>::type>::value> {
};

#define ASIO_PRIVATE_NOTHROW_RECEIVER_OF_TRAITS_DEF(n)                                                                                                                                      \
    template <typename T, ASIO_VARIADIC_TPARAMS(n)>                                                                                                                                         \
    struct is_nothrow_receiver_of<T, ASIO_VARIADIC_TARGS(n)> : integral_constant<bool,                                                                                                      \
                                                                                 is_receiver_of<T, ASIO_VARIADIC_TARGS(n)>::value && is_nothrow_set_value<typename remove_cvref<T>::type,   \

...
struct call_traits<R,
                   typename enable_if<
                       start_member<R>::is_valid>::type> : start_member<R> {
...
struct call_traits<R,
                   typename enable_if<
                       !start_member<R>::is_valid>::type,
                   typename enable_if<
                       start_free<R>::is_valid>::type> : start_free<R> {
...
template <typename R>
struct can_start : integral_constant<bool,
...
template <typename R>
struct is_nothrow_start : integral_constant<bool,

...
struct call_traits<R, Vs,
                   typename enable_if<
                       set_value_member<R, Vs>::is_valid>::type> : set_value_member<R, Vs> {
...
struct call_traits<R, Vs,
                   typename enable_if<
                       !set_value_member<R, Vs>::is_valid>::type,
                   typename enable_if<
                       set_value_free<R, Vs>::is_valid>::type> : set_value_free<R, Vs> {
...
#define ASIO_PRIVATE_SET_VALUE_CALL_DEF(n)                                        \
    ...
    ASIO_CONSTEXPR typename enable_if<                                            \
        ...
        typename call_traits<R, void(ASIO_VARIADIC_TARGS(n))>::result_type>::type \
...
template <typename R, typename... Vs>
struct can_set_value : integral_constant<bool,
...
template <typename R, typename... Vs>
struct is_nothrow_set_value : integral_constant<bool,
...
template <typename R>
struct can_set_value<R> : integral_constant<bool,
                                            asio_execution_set_value_fn::call_traits<R, void()>::overload !=
                                                asio_execution_set_value_fn::ill_formed> {
};

template <typename R>
struct is_nothrow_set_value<R> : integral_constant<bool,
                                                   asio_execution_set_value_fn::call_traits<R, void()>::is_noexcept> {
};

#define ASIO_PRIVATE_SET_VALUE_TRAITS_DEF(n)                                                                                                                          \
    template <typename R, ASIO_VARIADIC_TPARAMS(n)>                                                                                                                   \
    struct can_set_value<R, ASIO_VARIADIC_TARGS(n)> : integral_constant<bool,                                                                                         \
                                                                        asio_execution_set_value_fn::call_traits<R,                                                   \
                                                                            ...
                                                                            asio_execution_set_value_fn::ill_formed> {                                                \
                                                                                                                                                                      ...
                                                                                                                                                                      \
    template <typename R, ASIO_VARIADIC_TPARAMS(n)>                                                                                                                   \
    struct is_nothrow_set_value<R, ASIO_VARIADIC_TARGS(n)> : integral_constant<bool,                                                                                  \
                                                                               asio_execution_set_value_fn::call_traits<R,                                            \

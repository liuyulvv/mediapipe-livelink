...
struct relationship_t {
    ...
    static ASIO_CONSTEXPR
        ...
        static_query(
            ...
            typename enable_if<
                traits::static_query<T, fork_t>::is_valid>::type* = 0) ASIO_NOEXCEPT {
    ...
    static ASIO_CONSTEXPR
        ...
        static_query(
            ...
            typename enable_if<
                traits::static_query<T, continuation_t>::is_valid>::type* = 0) ASIO_NOEXCEPT {
        return traits::static_query<T, continuation_t>::value();
    }

    template <typename E,
              typename T = decltype(relationship_t::static_query<E>())>
    static ASIO_CONSTEXPR const T static_query_v = relationship_t::static_query<E>();
    ...
    friend ASIO_CONSTEXPR relationship_t query(
        ...
        typename enable_if<
            can_query<const Executor&, fork_t>::value>::type* = 0)
...
struct fork_t {
    ...
    static ASIO_CONSTEXPR fork_t static_query(
        ...
        typename enable_if<
            !query_member<T>::is_valid>::type* = 0,
        typename enable_if<
            !traits::query_free<T, fork_t>::is_valid>::type* = 0,
        typename enable_if<
...
struct continuation_t {
    ...
    static ASIO_CONSTEXPR const T static_query_v = continuation_t::static_query<E>();
#endif  // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
        //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)
...
struct query_free_default<T, execution::relationship_t,
                          typename enable_if<
                              !can_query<T, execution::relationship_t::fork_t>::value && can_query<T, execution::relationship_t::continuation_t>::value>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept =
...
struct static_query<T, execution::relationship_t,
                    typename enable_if<
                        ...
                        traits::static_query<T,
                                             execution::relationship_t::fork_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<T, execution::relationship_t,
                    typename enable_if<
                        ...
                        traits::static_query<T,
                                             execution::relationship_t::continuation_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_require<T, execution::relationship_t::continuation_t,
                      typename enable_if<
                          static_query<T, execution::relationship_t::continuation_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid =
                                    (is_same<typename static_query<T,

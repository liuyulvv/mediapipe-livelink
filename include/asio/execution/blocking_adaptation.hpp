...
struct blocking_adaptation_t {
    ...
    static ASIO_CONSTEXPR
        ...
        static_query(
            ...
            typename enable_if<
                traits::static_query<T, disallowed_t>::is_valid>::type* = 0) ASIO_NOEXCEPT {
    ...
    static ASIO_CONSTEXPR
        ...
        static_query(
            ...
            typename enable_if<
                traits::static_query<T, allowed_t>::is_valid>::type* = 0) ASIO_NOEXCEPT {
        return traits::static_query<T, allowed_t>::value();
    }

    template <typename E,
              typename T = decltype(blocking_adaptation_t::static_query<E>())>
    static ASIO_CONSTEXPR const T static_query_v = blocking_adaptation_t::static_query<E>();
    ...
    friend ASIO_CONSTEXPR blocking_adaptation_t query(
        ...
        typename enable_if<
            can_query<const Executor&, disallowed_t>::value>::type* = 0)
    ...
    friend ASIO_CONSTEXPR blocking_adaptation_t query(
        ...
        typename enable_if<
            !can_query<const Executor&, disallowed_t>::value>::type* = 0,
        typename enable_if<
            can_query<const Executor&, allowed_t>::value>::type* = 0)
#if !defined(__clang__)  // Clang crashes if noexcept is used here.
#if defined(ASIO_MSVC)   // Visual C++ wants the type to be qualified.
        ASIO_NOEXCEPT_IF((
            is_nothrow_query<const Executor&,
...
struct disallowed_t {
    ...
    static ASIO_CONSTEXPR disallowed_t static_query(
        ...
        typename enable_if<
            !query_member<T>::is_valid>::type* = 0,
        typename enable_if<
            !traits::query_free<T, disallowed_t>::is_valid>::type* = 0,
        typename enable_if<
    ...
    static ASIO_CONSTEXPR const T static_query_v = disallowed_t::static_query<E>();
#endif  // defined(ASIO_HAS_DEDUCED_STATIC_QUERY_TRAIT)
        //   && defined(ASIO_HAS_SFINAE_VARIABLE_TEMPLATES)
...
struct query_free_default<T, execution::blocking_adaptation_t,
                          typename enable_if<
                              can_query<T, execution::blocking_adaptation_t::disallowed_t>::value>::type> {
...
struct query_free_default<T, execution::blocking_adaptation_t,
                          typename enable_if<
                              !can_query<T, execution::blocking_adaptation_t::disallowed_t>::value && can_query<T, execution::blocking_adaptation_t::allowed_t>::value>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
...
struct static_query<T, execution::blocking_adaptation_t,
                    typename enable_if<
                        ...
                        traits::static_query<T,
                                             execution::blocking_adaptation_t::disallowed_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<T, execution::blocking_adaptation_t,
                    typename enable_if<
                        ...
                        traits::static_query<T,
                                             execution::blocking_adaptation_t::allowed_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_query<T, execution::blocking_adaptation_t::disallowed_t,
                    typename enable_if<
                        ...
                        !traits::query_free<T,
                                            execution::blocking_adaptation_t::disallowed_t>::is_valid &&
                        !can_query<T, execution::blocking_adaptation_t::allowed_t>::value>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
    ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
...
struct static_require<T, execution::blocking_adaptation_t::disallowed_t,
                      typename enable_if<
                          static_query<T, execution::blocking_adaptation_t::disallowed_t>::is_valid>::type> {
...
struct static_require<T, execution::blocking_adaptation_t::allowed_t,
                      typename enable_if<
                          static_query<T, execution::blocking_adaptation_t::allowed_t>::is_valid>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid =
                                    (is_same<typename static_query<T,
...
struct require_free_default<T, execution::blocking_adaptation_t::allowed_t,
                            typename enable_if<
                                is_same<T, typename decay<T>::type>::value && execution::is_executor<T>::value>::type> {
    ASIO_STATIC_CONSTEXPR(bool, is_valid = true);

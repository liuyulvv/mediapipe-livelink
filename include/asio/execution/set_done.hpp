...
struct call_traits<R,
                   typename enable_if<
                       set_done_member<R>::is_valid>::type> : set_done_member<R> {
...
struct call_traits<R,
                   typename enable_if<
                       !set_done_member<R>::is_valid>::type,
                   typename enable_if<
                       set_done_free<R>::is_valid>::type> : set_done_free<R> {
...
template <typename R>
struct can_set_done : integral_constant<bool,
...
template <typename R>
struct is_nothrow_set_done : integral_constant<bool,

...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       decay<Property>::type::is_requirable_concept>::type,
                   typename enable_if<
...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       require_concept_member<
                           ...
                           Property>::is_valid>::type> : require_concept_member<typename Impl::template proxy<T>::type,
                                                                                Property> {
...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       require_concept_free<T, Property>::is_valid>::type> : require_concept_free<T, Property> {
...
struct impl {
    ...
    struct proxy {
        ...
        struct type {
            template <typename P>
            auto require_concept(ASIO_MOVE_ARG(P) p) noexcept(
                noexcept(
                    declval<typename conditional<true, T, P>::type>().require_concept(
                        ASIO_MOVE_CAST(P)(p))))
                -> decltype(declval<typename conditional<true, T, P>::type>().require_concept(
                    ASIO_MOVE_CAST(P)(p)));
        };
...
template <typename T, typename Property>
struct is_nothrow_require_concept : integral_constant<bool,
                                                      asio_require_concept_fn::call_traits<

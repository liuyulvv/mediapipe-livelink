 ...
 */
template <typename T>
ASIO_NODISCARD inline executor_work_guard<typename associated_executor<T>::type>
make_work_guard(const T& t,
                typename constraint<
                    !is_executor<T>::value>::type = 0,
                typename constraint<
                    !execution::is_executor<T>::value>::type = 0,
                typename constraint<
...
ASIO_NODISCARD inline executor_work_guard<typename associated_executor<T, Executor>::type>

...
public:
    ...
    void async_send(implementation_type<Traits, Signatures...>& impl,
        ...
        typename associated_cancellation_slot<Handler>::type slot = asio::get_associated_cancellation_slot(handler);
...
private:
    ...
    public:
        ...
        void operator()(cancellation_type_t type) {
            if (!!(type &
                   (cancellation_type::terminal | cancellation_type::partial | cancellation_type::total))) {
...
struct channel_service<Mutex>::implementation_type : base_implementation_type {
    ...
    typedef typename conditional<
        ...
        typename conditional<
            ...
            channel_payload<
                Signatures...,
                typename traits_type::receive_closed_signature> >::type,
        typename conditional<
            has_signature<
                typename traits_type::receive_closed_signature,
                Signatures...,
            ...
            channel_payload<
                Signatures...,
                typename traits_type::receive_cancelled_signature,
                typename traits_type::receive_closed_signature> >::type>::type payload_type;

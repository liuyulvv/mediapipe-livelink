...
struct associated_executor_impl<T, E,
                                typename enable_if<
                                    !has_executor_type<T>::value>::type,
                                typename void_type<
                                    typename associator<associated_executor, T, E>::type>::type> : associator<associated_executor, T, E> {
};
...
get_associated_executor(const T& t, const Executor& ex,
                        typename constraint<
                            is_executor<Executor>::value || execution::is_executor<Executor>::value>::type = 0) ASIO_NOEXCEPT {
...
#if defined(ASIO_HAS_STD_REFERENCE_WRAPPER) || defined(GENERATING_DOCUMENTATION)

...
#if (defined(ASIO_HAS_STD_TUPLE) && defined(ASIO_HAS_VARIADIC_TEMPLATES)) || defined(GENERATING_DOCUMENTATION)
...
/// arguments should be combined into a single tuple argument.
template <typename CompletionToken>
ASIO_NODISCARD inline ASIO_CONSTEXPR as_tuple_t<typename decay<CompletionToken>::type>

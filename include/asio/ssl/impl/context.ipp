...
context::~context() {
    if (handle_) {
#if ((OPENSSL_VERSION_NUMBER >= 0x10100000L) && (!defined(LIBRESSL_VERSION_NUMBER) || LIBRESSL_VERSION_NUMBER >= 0x2070000fL)) || defined(ASIO_USE_WOLFSSL)
...
#if ((OPENSSL_VERSION_NUMBER >= 0x10002000L) && (!defined(LIBRESSL_VERSION_NUMBER) || LIBRESSL_VERSION_NUMBER >= 0x2090100fL)) || defined(ASIO_USE_WOLFSSL)

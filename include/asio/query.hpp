...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       static_query<T, Property>::is_valid>::type> : static_query<T, Property> {
...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       query_member<typename Impl::template proxy<T>::type, Property>::is_valid>::type> : query_member<typename Impl::template proxy<T>::type, Property> {
...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       !static_query<T, Property>::is_valid>::type,
                   typename enable_if<
                       !query_member<typename Impl::template proxy<T>::type, Property>::is_valid>::type,
                   typename enable_if<
...
struct impl {
    ...
    struct proxy {
        ...
        struct type {
            template <typename P>
            auto query(ASIO_MOVE_ARG(P) p) noexcept(
                noexcept(
...
template <typename T, typename Property>
struct is_nothrow_query : integral_constant<bool,

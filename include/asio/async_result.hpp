...
struct are_completion_signatures<T0, TN...>
    : integral_constant<bool, (
                                  is_completion_signature<T0>::value && are_completion_signatures<TN...>::value)> {
};
...
struct are_simple_completion_signatures<Sig0, SigN...>
    : integral_constant<bool, (
                                  is_simple_completion_signature<Sig0>::value && are_simple_completion_signatures<SigN...>::value)> {
};
...
struct are_simple_completion_signatures<Sig0, Sig1>
    : integral_constant<bool,
                        (is_simple_completion_signature<Sig0>::value && is_simple_completion_signature<Sig1>::value)> {
};

template <typename Sig0, typename Sig1, typename Sig2>
struct are_simple_completion_signatures<Sig0, Sig1, Sig2>
    : integral_constant<bool,
                        (is_simple_completion_signature<Sig0>::value && is_simple_completion_signature<Sig1>::value && is_simple_completion_signature<Sig2>::value)> {
};
...
template <typename CompletionToken, ASIO_COMPLETION_SIGNATURES_TPARAMS>
class async_result : public conditional<
...
public:
    typedef typename conditional<
        ...
        detail::completion_handler_async_result<
            CompletionToken, ASIO_COMPLETION_SIGNATURES_TARGS>,
        async_result<CompletionToken,
                     ASIO_COMPLETION_SIGNATURES_TSIMPLEARGS> >::type base_type;
...
template <typename CompletionToken, ASIO_COMPLETION_SIGNATURES_TPARAMS>
class async_result : public detail::completion_handler_async_result<
                         CompletionToken, ASIO_COMPLETION_SIGNATURES_TARGS> {
public:
...
struct async_result_has_initiate_memfn
    : integral_constant<bool, sizeof(async_result_initiate_memfn_helper<
                                     async_result<typename decay<CompletionToken>::type,
                                                  ASIO_COMPLETION_SIGNATURES_TARGS> >(0)) != 1> {
};
                               ...
                               typename void_type<
                                   typename enable_if<
                                       is_same<
                                           ...
                                           async_operation_probe_result>::value>::type>::type> : true_type {
};
...
template <typename T, typename... Args>
struct is_async_operation : detail::is_async_operation_call<
...
#define ASIO_PRIVATE_IS_ASYNC_OP_DEF(n)                                                                                    \
    ...
    struct is_async_operation<T, ASIO_VARIADIC_TARGS(n)> : detail::is_async_operation_call<                                \
...
template <typename T, typename... Args>
struct completion_signature_of : result_of<T(Args..., detail::completion_signature_probe)>::type {
};
...
template <typename T, typename = void, typename = void, typename = void,
          typename = void, typename = void, typename = void, typename = void,
          typename = void, typename = void>
struct completion_signature_of : result_of<T(detail::completion_signature_probe)>::type {
};

#define ASIO_PRIVATE_COMPLETION_SIG_OF_DEF(n)                                                                      \
    template <typename T, ASIO_VARIADIC_TPARAMS(n)>                                                                \
    struct completion_signature_of<T, ASIO_VARIADIC_TARGS(n)> : result_of<                                         \

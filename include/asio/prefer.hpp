...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       decay<Property>::type::is_preferable>::type,
                   typename enable_if<
...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       !static_require<T, Property>::is_valid>::type,
                   typename enable_if<
                       require_member<typename Impl::template proxy<T>::type, Property>::is_valid>::type> : require_member<typename Impl::template proxy<T>::type, Property> {
...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       !static_require<T, Property>::is_valid>::type,
                   typename enable_if<
                       !require_member<typename Impl::template proxy<T>::type, Property>::is_valid>::type,
                   typename enable_if<
                       require_free<T, Property>::is_valid>::type> : require_free<T, Property> {
...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       prefer_member<typename Impl::template proxy<T>::type, Property>::is_valid>::type> : prefer_member<typename Impl::template proxy<T>::type, Property> {
...
struct call_traits<Impl, T, void(Property),
                   ...
                   typename enable_if<
                       !require_free<T, Property>::is_valid>::type,
                   typename enable_if<
                       !prefer_member<typename Impl::template proxy<T>::type, Property>::is_valid>::type,
                   typename enable_if<
...
struct call_traits<Impl, T, void(P0, P1),
                   typename enable_if<
                       call_traits<Impl, T, void(P0)>::overload != ill_formed>::type,
                   typename enable_if<
                       call_traits<
                           Impl,
...
struct call_traits<Impl, T, void(P0, P1, PN ASIO_ELLIPSIS),
                   ...
                   typename enable_if<
                       call_traits<
                           Impl,
                           typename call_traits<Impl, T, void(P0)>::result_type,
                           void(P1, PN ASIO_ELLIPSIS)>::overload != ill_formed>::type> {
    ...
    typedef typename decay<
        typename call_traits<
            Impl,
            typename call_traits<Impl, T, void(P0)>::result_type,
            void(P1, PN ASIO_ELLIPSIS)>::result_type>::type result_type;
};
...
struct impl {
    ...
    struct proxy {
        ...
        struct type {
            template <typename P>
            auto require(ASIO_MOVE_ARG(P) p) noexcept(
                noexcept(
                    declval<typename conditional<true, T, P>::type>().require(
                        ASIO_MOVE_CAST(P)(p))))
                -> decltype(declval<typename conditional<true, T, P>::type>().require(
                    ASIO_MOVE_CAST(P)(p)));

            template <typename P>
            auto prefer(ASIO_MOVE_ARG(P) p) noexcept(
                noexcept(
                    declval<typename conditional<true, T, P>::type>().prefer(
                        ASIO_MOVE_CAST(P)(p))))
                -> decltype(declval<typename conditional<true, T, P>::type>().prefer(
                    ASIO_MOVE_CAST(P)(p)));
        };
    ...
    ASIO_NODISCARD ASIO_CONSTEXPR typename enable_if<
        ...
        typename call_traits<impl, T, void(P0, P1)>::result_type>::type
    operator()(
        ASIO_MOVE_ARG(T) t,
        ASIO_MOVE_ARG(P0) p0,
...
template <typename T, typename... Properties>
struct can_prefer : integral_constant<bool,
                                      asio_prefer_fn::call_traits<
                                          prefer_t, T, void(Properties...)>::overload != asio_prefer_fn::ill_formed> {
};
...
struct can_prefer : integral_constant<bool,
                                      asio_prefer_fn::call_traits<
                                          prefer_t, T, void(P0, P1, P2)>::overload != asio_prefer_fn::ill_formed> {
};

template <typename T, typename P0, typename P1>
struct can_prefer<T, P0, P1> : integral_constant<bool,
                                                 asio_prefer_fn::call_traits<
                                                     prefer_t, T, void(P0, P1)>::overload != asio_prefer_fn::ill_formed> {
};

template <typename T, typename P0>
struct can_prefer<T, P0> : integral_constant<bool,
                                             asio_prefer_fn::call_traits<
                                                 prefer_t, T, void(P0)>::overload != asio_prefer_fn::ill_formed> {
};

template <typename T>
struct can_prefer<T> : false_type {
};
...
template <typename T, typename... Properties>
struct is_nothrow_prefer : integral_constant<bool,
                                             asio_prefer_fn::call_traits<
...
template <typename T, typename P0>
struct is_nothrow_prefer<T, P0> : integral_constant<bool,
                                                    asio_prefer_fn::call_traits<
                                                        prefer_t, T, void(P0)>::is_noexcept> {
};

template <typename T>
struct is_nothrow_prefer<T> : false_type {
};
...
template <typename T, typename ASIO_ELLIPSIS Properties>
constexpr bool is_nothrow_prefer_v = is_nothrow_prefer<T, Properties ASIO_ELLIPSIS>::value;

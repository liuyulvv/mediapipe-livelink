...
#if defined(ASIO_HAS_VARIADIC_TEMPLATES) && defined(ASIO_HAS_STD_TUPLE)
...
public:
    ...
    void operator()(ASIO_MOVE_ARG(Handler) handler,
        ...
        typename associated_cancellation_slot<handler_type>::type slot = asio::get_associated_cancellation_slot(handler);

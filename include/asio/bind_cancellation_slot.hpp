...
ASIO_NODISCARD inline cancellation_slot_binder<typename decay<T>::type, CancellationSlot>
...
struct cancellation_slot_binder_async_result_completion_handler_type<
    ...
    typename void_type<
        typename TargetAsyncResult::completion_handler_type>::type> {
...
struct cancellation_slot_binder_async_result_return_type<
    TargetAsyncResult,
    typename void_type<
        typename TargetAsyncResult::return_type>::type> {
...
class async_result<cancellation_slot_binder<T, CancellationSlot>, Signature> : public detail::cancellation_slot_binder_async_result_completion_handler_type<

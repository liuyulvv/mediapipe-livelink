...
#define ASIO_CONCURRENCY_HINT_SAFE \
    static_cast<int>(ASIO_CONCURRENCY_HINT_ID | ASIO_CONCURRENCY_HINT_LOCKING_SCHEDULER | ASIO_CONCURRENCY_HINT_LOCKING_REACTOR_REGISTRATION | ASIO_CONCURRENCY_HINT_LOCKING_REACTOR_IO)
